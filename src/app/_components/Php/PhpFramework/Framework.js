...
import LaravelIcon from '../../../../../Components/Images/phpicon.png'
    ...
    return (
        <div className='flex flex-col md:flex-row items-center justify-center md:h-[262px] mt-10'>
            ...
            <div className="text-area basis-[60%] flex flex-col justify-between h-full py-5 px-5 gap-6 md:gap-0 md:px-0 md:pr-30">
                <h1 className='text-[20px] font-[700] leading-[24px]'>Dynamic and Server-Side Scripting Language</h1>
                <p className='text-[15px] leading-[28px] md:mt-5 text-justify'>PHP (Hypertext Preprocessor) is a popular server-side scripting language widely used for web development. Known for its ease of use, flexibility, and integration with HTML, PHP powers millions of websites and web applications, including content management systems like WordPress, Drupal, and Joomla.</p>
